    ...
    configure({
      generateMessage: (ctx) => {
        const messages = {
          ...
          alpha_spaces: `The field ${ctx.field} can contain only alphabetical characters and spaces.`,
          email: `The field ${ctx.field} must be  valid email address.`,
      ...
      // Validation triggers (bellow are the defaults)
      validateOnBlur: true,
