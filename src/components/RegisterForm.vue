<template>
    ...
    >
        ...
        <!-- Password (with multiple error messages) -->
        <div class="mb-3">
...
export default {
    ...
    data() {
        return {
            // registration form validation & submission status
            schema: {
                ...
                country: "required|country_excluded:Austria",
                tos: "tos",
            },
            userData: {
                country: "Germany"
    ...
    methods: {
        async register(values) {
            ...
            try {
                ...
                this.reg_alert_msg = 'An error occurred while creating your account. Please try again.';
